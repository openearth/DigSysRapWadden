...
Het is belangrijk om te realiseren dat de hier weergegeven representatieve orbitaalsnelheden geen gemeten data betreft maar gebaseerd is op modelbewerkingen die ook gebruikt zijn voor het maken van de huidige ecotopenkaarten. Hoewel geen gemeten data, zijn deze orbitaalsnelheden op verzoek van veel gebruikers toch opgenomen in deorbitaalstroomsnelheden geven. 
