...
```{r, fig.cap="Gemiddeld hoog hoogwater (boven) en gemiddeld laag laagwater (onder) voor stations in de Waddenzee. "}

path = file.path(datadir, "ddl", "calculated", "tidal_indicators", "GHHWS_GLLWS_10min.png")

file.copy(path, "images/GHHWS_GLLWS_10min.png", overwrite = T)
...
file.copy(path, "images/ts_M2.png", overwrite = T)
...
file.copy(path, "images/ts_S2.png", overwrite = T)
...
file.copy(path, "images/ts_M4.png", overwrite = T)
...
file.copy(path, "images/ts_M4divM2.png", overwrite = T)
...
ref:stormhoogteLabel Tijdserie van stormhoogte, berekend als 99,5-percentiel van de gemeten waterhoogte per jaar. De locaties van de stations zijn te vinden in \@ref(fig:kaartAbiotieklocaties). 

```{r stormhoogte, fig.cap="(ref:stormhoogteLabel)", fig.width=10, fig.height=5}
...
file.copy(file.path(datadir, "NLWKN", "afvoeren", "raw", "2022_07_06_Discharges Ems.jpg"), "images/2022_07_06_Discharges Ems.jpg", overwrite = T)
