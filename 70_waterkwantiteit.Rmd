...
```{r kaartGetijslag, fig.height=6, fig.width=8, fig.cap="Gemiddelde getijslag per station over het meest recente jaar waar volledige gegevens beschikbaar zijn (`r endyear`)."}
