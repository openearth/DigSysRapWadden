...
**Komende 30 jaar**
 ...
 \ref(fig:bodemdalingmonitor-doorwinning-prognose) laat zien dat de bodemdaling in de komende 30
jaar in het algemeen minder zal zijn dan in de afgelopen 30 jaar. Dit is een gevolg van
verminderde gaswinning, waardoor op de meeste locaties nog slechts enkele centimeters
bodemdaling verwacht wordt. Rondom Ameland en het Groninger gasveld kan nog wel tot
rond 10 cm aanvullende bodemdaling optreden. De onzekerheid rondom deze getallen is
groter dan voor de afgelopen 30 jaar, omdat deze getallen alleen gebaseerd zijn op
modellering en omdat winningsplannen nog kunnen wijzigen. In lijn met de eerdere Bodemdalingmonitor wordt de onzekerheid (variatiecoëfficiënt) rondom de bodemdalingsgetallen voor de
komende 30 jaar daarom op ± 50% geschat. Binnenkort zijn beide kaarten ook beschikbaar via Datahuis Wadden. 

```{r bodemdalingmonitor-doorwinning-prognose, fig.cap="Bodembeweging door winning van gas, olie en zout voor de komende 30 jaar."}

knitr::include_graphics("images/bodemdalingmonitor-doorwinning-prognose.png")
```
