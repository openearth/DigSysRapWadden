...
Daarnaast kunnen binnen deze bekkens ook nog verschillende kombergingen worden aangewezen. In deze rapportage wordt voorlopig alleen het Marsdiep onderverdeeld in verschillende deelgebieden. De volgende deelgebieden worden gehanteerd: Balgzand, Boontjes, Doovebalg, Scheurrak, Texelstroom en Zwanenbalg, zoals te zien in Figuur \@ref(fig:deelgebiedenWaddenzee). Voor de andere bekkens worden de grenzen nog bepaald.  
...
leaflet(deelgebieden_sf %>% st_transform(4326)) %>%
  addTiles() %>%
  addPolygons(label = ~deelgebied, labelOptions = labelOptions(noHide = T))
