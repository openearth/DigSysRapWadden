...
Bovenstaande wordt beoordeeld en geduid in de kombergingsrapportages aan de hand van een aantal (bijna 200 voor de gehele Waddenzee) geuldoorsnedes (profielen) op vaste locaties, wat een vergelijking tussen verschillende jaren mogelijk maakt. Klikken op een profiellijn in Figuur \@ref(fig:geul-kaart) geeft een figuur met de geuldoorsnedes voor de vaklodingen tussen 1927 en nu. De data na 1991 zijn gecomnbineerde bathymetriën van de vaklodingen die per kombergingsgebied per jaar plaatsvinden. Ze refereren dus naar een geuldoorsnedes per periode. De data van de combineerde bathymetriën is binnenkort ook te vinden op Datahuis Wadden. 
