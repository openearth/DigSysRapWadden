...
*NB Onderstaande beschrijft de huidige methode, op basis van vaste verticale begrenzingen ten opzichte van NAP. Deze methode geeft inzicht in de absolute volumes of oppervlaktes, maar relateert die niet aan de vanuit morfologisch en ecologisch opzicht relevantere waterstand zoals GLW of GHW die door de jaren en ruimtelijk varieert. Een methode die daar wel recht aan doet is momenteel in ontwikkeling en wordt dit jaar beproefd op het bekken van ht Vlie. Het is de bedoeling de nieuwe methode in 2025 voor alle Waddenzeebekkens op de DSR te gebruiken.*
