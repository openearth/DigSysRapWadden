...
*NB Onderstaande beschrijft de huidige methode, op basis van vaste verticale begrenzingen ten opzichte van NAP. Deze methode geeft inzicht in de absolute volumes of oppervlaktes, maar relateert die niet aan de vanuit morfologisch en ecologisch opzicht relevantere waterstand zoals GLW of GHW die door de jaren en ruimtelijk varieert. Een methode die daar wel recht aan doet is momenteel in ontwikkeling en wordt dit jaar beproefd op het Vlie. Het is de bedoeling de nieuwe methode in 2025 voor alle Waddenzeebekkens op de DSR te gebruiken.*
...
1.  Geul (z < -5m)
2.  Subgetijdengebied (-5m < z < -1m)
3.  Intergetijdengebied (-1m < z < 1m)
4.  Supragetijdengebied (z > 1m)

De geulen zijn indicatief voor de transportcapaciteit van het systeem, terwijl ze door de sterke hydrodynamiek vaak arm zijn aan bodemleven. Het subgetijdengebied ligt permanent onder water maar is over het algemeen rustiger en heeft daarmee een functie als bijvoorbeeld kraamkamer voor jonge vis. Het intergetijdengebied betreft het areaal dat een deel van de tijd droogvalt, en is zeer waardevol als foerageergebied voor vogels. Op het hoogste deel, wat het langst droogvalt, kan kweldervorming optreden.  Het supragetijdengebied overstroomt onregelmatig, als gevolg van springtij en stormopzet. Hier kan zich dichte begroeiïng (hoge kwelder) ontwikkelen, of eilandvorming (duinen) optreden. 
...
```{r arealen_nieuw, fig.cap = "Arealen voor verschillende diepteklassen met nieuwe bathymetrie en diepteklassen gerelateerd aan GHW en GLW (preliminair)."}

knitr::include_url("https://deltares.shinyapps.io/plot_arealen/", height = "600px")
