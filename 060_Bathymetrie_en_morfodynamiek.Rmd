...
Figuur \@ref(fig:hypsometriearealen) toont de hypsometrische curves voor de bekkens in de Waddenzee. De verschillende klassen zijn met kleur aangegeven op de kaart. De veranderingen tussen de jaren (kolommen) zijn klein. In figuur \@ref(fig:hypsometriearealen2) zijn de verschillende jaren over elkaar geplot en is tevens de mogelijkheid verder in te zoomen.
