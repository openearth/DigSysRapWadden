...
<!-- Om vat te krijgen op de ontwikkelingen en trends beschouwen we verschillende indicatoren. Figuur \@ref(fig:infographic_morfologie) laat zien hoe deze indicatoren gecombineerd kunnen worden om ontwikkelingen van een bekken te begrijpen.  -->
<!-- ```{r infographic_morfologie, fig.cap= "Overzicht van de belangrijkste morfologische indicatoren (volumeveranderingen, hypsometrie, ontwikkeling van arealen) en de wijze waarop deze indicatoren samen informatie geven over de ontwikkeling van een bekken." } -->
...
-	**Eijerlandse Gat**: Tussen 1989 en 2005 is het intergetijdegebied hier toegenomen, ten koste van met name het subgetijdegebied. Sinds 2005 is deze ontwikkeling afgevlakt en is de verdeling in diepteklassen gelijk gebleven.
-	**Vlie**: Het totale bekkenoppervlak is enkele procenten afgenomen door wantijmigratie (met name uitbreiding van het Marsdiep en Eijerlandse Gat). De verdeling van diepteklassen binnen het bekken is relatief gelijk gebleven.
...
-	**Pinkegat en Zoutkamperlaag** (vormen samen het Friesche Zeegat): de verdeling van diepteklassen is relatief gelijk gebleven. 
-	**Groninger Wad**: Het aandeel intergetijdegebied is afgenomen, met name door een uitbreiding van subgetijdegebied.
