...
De totale lengte van de laagwaterlijnen is bepaald voor dezelfde jaren als de andere indicatoren, en weer voor elk bekken. in figuur \@ref(fig:plotAllregions) is de cumulatieve lengte voor de hele Waddenzee (minus Eems-Dollard) te zien. Voor de afzonderlijke bekkens geldt dat de lengte in de meeste gevallen is toegenomen over de tijd, of op zijn minst ongeveer gelijk gebleven \@ref(fig:lengteLaagwaterLijn) . 


(ref:plotAllregions-label) Ontwikkeling van de laagwaterlijn, bepaald op een vaste diepte van `r laagwaterlijn`` m NAP, voor de gehele Waddenzee minus het Eems estuarium.
...
(ref:lengteLaagwaterLijn-label) Ontwikkeling (tijdreeks) van de lengte van de laagwaterlijn, geschat uit de contour op `r laagwaterlijn`` m NAP. 
