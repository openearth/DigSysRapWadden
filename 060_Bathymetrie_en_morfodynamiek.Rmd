...
(ref:geul-kaartLabel) Interactieve kaart van geuldoorsnedes van profielen over de tijd in het Waddengebied. Klikken op ee profiel laat de verandering in de geuldiepte over de tijd zien. ([Link naar Schermvullende versie](https://www.testsysteemrapportage.nl/Concept_webgis_geuldoorsnedes/index.html)). 
...
```{r Wang2018Sedbalans, fig.cap= "(ref:Wang2018Sedbalans-label)" }
