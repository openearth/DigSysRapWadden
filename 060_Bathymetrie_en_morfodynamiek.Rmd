...
## Sedimentbalans
Omdat een dergelijke analyse complex is, en nog niet afgerond is (verwachting: 2025), zijn de opgenomen netto erosie/sedimentatie en de sedimentbalans gebaseerd op een eerdere studie van [Wang et al. (2018)](https://www.cambridge.org/core/services/aop-cambridge-core/content/view/43109B1810D68CF36D1C91405EA37F0A/S0016774618000082a.pdf/div-class-title-sediment-budget-and-morphological-development-of-the-dutch-wadden-sea-impact-of-accelerated-sea-level-rise-and-subsidence-until-2100-div.pdf); de resultaten zijn daarom slechts als figuren beschikbaar en niet interactief bevraagbaar.
...
##	Bodemsamenstelling (SIBES)
Synoptic Intertidal Benthic Surveys (SIBES) is een inventarisatie macrozoobenthos en sediment korrelgrootte in de Waddenzee. De dataset bevat beschrijvingen van de soortensamenstelling macrozoobenthische infauna van droogvallende delen in de gehele Nederlandse Waddenzee. Daarnaast bevat de dataset beschrijvingen van de sediment korrelgrootte samenstelling van droogvallende delen in de gehele Nederlandse Waddenzee. 

Het doel waarvoor de data wordt verzameld is het bepalen van langetermijnverandering macrozoobenthos in de Waddenzee, consequenties voor draagkracht van het gebied draagkracht Waddenzee. Daarnaast het bepalen van de effecten van bodemdaling op het benthische ecosysteem van de Waddenzee en monitoring van exoten in het gebied. De data wordt verzameld door het NIOZ. De data is beschikbaar van 2008 tot 2019.

De dataset is te bekijken en te downloaden via [Datahuis Wadden Waddenviewer](https://viewer.openearth.nl/wadden-viewer/?folders=93790295%2C93793330%2C107902964&layers=123516301&layerNames=B27%3A+SIBES%3A+Sediment+%282009-2019%29+). Meer informatie is te vinden via het [Waddenregister](https://datahuiswadden.openearth.nl/geonetwork/srv/dut/catalog.search#/metadata/123516301). 
