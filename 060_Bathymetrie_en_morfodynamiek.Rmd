...
<!-- nieuwe berekenening door o.a. Edwin Elias, gebruikt variabel wantij en ruimtelijk variabele dieptegrenzen t.o.v. HW en LW -->
...
```{r stackedAreas, fig.width=8, fig.height=8,  fig.cap = ""}
...
```{r barPlotArealen, out.width = 8, out.height = 8, fig.cap = ""}
