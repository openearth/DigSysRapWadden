...
## Versiebeheer
De R-code waaruit deze digitale systeemrapportage is gemaakt (tekst, scripts en figuren) wordt bewaard op SVN onder versiebeheer (https://repos.deltares.nl/repos/DigSysRapWadden/). 
...
In 2023 wordt deze systeemrapportage waarschijnlijk gemigreerd naar een Github code, waarmee de toegang tot de broncode eenvoudiger wordt.
