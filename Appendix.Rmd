...
path = file.path(datadir, "ddl", "standard", paste0("waterhoogte", "Delfzijl", "2021-08-05", ".Rdata"))
...
### Additionele arealenvisualisatie
...
# dataoverzicht <- read_excel(file.path(projectDataPath, "wadden", "dataoverzicht.xlsx")) 
# write_delim(dataoverzicht, file.path(projectDataPath, "wadden", "dataoverzicht.csv"), delim = ";")
dataoverzicht <- read_delim(file.path(datadir, "dataoverzicht.csv"), delim = ";") %>% 
